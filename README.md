...
## Donations : RKvdM7TLMSRQpC3rXMegRrzwUEbv61zbg3
##
...
# Run on the test network instead of the real ravencoin network.
#testnet=0
...
#addnode=69.164.218.197:8766
#addnode=10.0.0.2:8766

# Alternatively use as many connect= settings as you like to connect ONLY to specific peers
#connect=69.164.218.197:8766
#connect=10.0.0.1:8766

# Listening mode, enabled by default except when 'connect' is being used
#listen=1

# Port on which to listen for connections (default: 8766, testnet: 18766, regtest: ?)
#port=
...
#
# JSON-RPC options (for controlling a running Ravencoin/ravend process)
#
...
# Refer to the manpage or ravend -help for further details.
#rpcbind=<addr>
...
# String to be appended to ravend.conf:
...
# How many seconds ravencoin will wait for a complete RPC HTTP request.
...
#rpcallowip=192.168.1.* #for local racks
...
# You can use RavenQT or ravend to send commands to Ravencoin/ravend
